...
[_QWERTY] = LAYOUT(
  ...
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,          INS_R_C,          ROW_SRT, KC_UP,   ROW_END, NXT_SHT,          KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_SCLN,
...
[_NAV] = LAYOUT(
  ...
  _______, KC_GRV,  KC_HOME, MS_WHLD, KC_END,  KC_LBRC, _______,          _______,          _______, _______, _______, _______,          _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
  _______, XXXXXXX, MS_WHLR, MS_WHLU, MS_WHLL, KC_MINS, _______,          _______,          _______, _______, _______, _______,          _______, XXXXXXX, _______, KC_RSFT, KC_RALT, KC_RCTL, _______,
  _______, XXXXXXX, XXXXXXX, GUI_BL,  GUI_BR,  XXXXXXX,                   _______,          _______, _______, _______, _______,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
...
combo_t key_combos[] = {
  [ESC_TAB_CAPSLOCK] = COMBO(esc_tab_combo, KC_CAPS)
};
