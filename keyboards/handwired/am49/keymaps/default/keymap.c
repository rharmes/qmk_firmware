...
/* Keymap 1: Arrows layer (cyan underglow) - Cursor movement, media keys, numpad, and clipboard shortcuts
 *
 *      ,------.------.------.------.------.                                                                   ,------.------.------.------.------.
 *      |      |      |      |      |      |                                                                   | Mute | Vol- | Vol+ |      |      |
 *      |------+------+------+------+------|                                                                   |------+------+------+------+------|
...
/* Keymap 2: Nav layer (magenta underglow) - Navigation shortcuts and media keys
 *
 *      ,------.------.------.------.------.                                                                   ,------.------.------.------.------.
...
[_NAV] = LAYOUT(
  ...
  KC_GRV,  KC_HOME, MS_WHLD, KC_END,  KC_LBRC,                                                                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  KC_VOLU, MS_WHLR, MS_WHLU, MS_WHLL, KC_MINS,                                                                XXXXXXX, _______, KC_RSFT, KC_RALT, KC_RCTL,
  KC_VOLD, XXXXXXX, GUI_BL,  GUI_BR,  XXXXXXX,                                                                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                      _______, _______, _______, CAM_TOG, QK_BOOT, _______, _______, _______, _______
),
 ...
 *      `------'------'------'------'------',------.                                                   ,------.`------'------'------'------'------'
 *                                   ,------|      |------. ,----------. ,-------. ,----------. ,------|      |------.
 *                                   |      |  Spc |      | |Mic Toggle| | TG(7) | | Zoom End | |      |  Ent |      |
 *                                   |  Esc |  (⌘) |  Del | `----------' `-------' `----------' |  BS  |  (⌘) |  Tab |
 *                                   |      |      |      |                                     |      |      |      |
 *                                   `------'------'------'                                     `------'------'------'
 */
...
[_34_SYM] = LAYOUT(
  ...
  SFT_6,   SFT_2,   GUI_BL,  GUI_BR,  SFT_3,                                                                  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                                      _______, KC_TAB,  KC_ESC,  CAM_TOG, QK_BOOT, _______, _______, _______, _______
),
...
const rgblight_segment_t PROGMEM qwerty_34_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 1, 0, 0, BRIGHTNESS} // White
);
